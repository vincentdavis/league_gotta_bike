...
class OrganizationBaseForm(forms.ModelForm):
    ...
    class Meta:
        model = Organization
        fields = ['name', 'description', 'contact_email', 'contact_phone', 'logo']
        widgets = {
...
class TeamCreateForm(OrganizationBaseForm):
    ...
    parent = forms.ModelChoiceField(
        ...
        label='League',
        help_text='Select the league this team belongs to'
    )
...
class OrganizationEditForm(forms.ModelForm):
    ...
    class Meta:
        model = Organization
        fields = ['name', 'slug', 'description', 'contact_email', 'contact_phone', 'logo', 'is_active']
        widgets = {
            'name': forms.TextInput(attrs={
                'class': 'input input-bordered w-full'
            }),
