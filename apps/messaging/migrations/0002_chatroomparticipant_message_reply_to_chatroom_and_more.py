# Generated by Django 5.2.6 on 2025-10-17 16:32
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('organizations', '0006_remove_team_fields'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='message',
            name='reply_to',
            field=models.ForeignKey(blank=True, help_text='Message this is replying to (for threading)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='replies', to='messaging.message'),
        ),
        migrations.CreateModel(
            name='ChatRoom',
            fields=[
        ...
        migrations.AddField(
            model_name='message',
            name='chat_room',
            field=models.ForeignKey(blank=True, help_text='Chat room this message belongs to (null for legacy messages)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='messaging.chatroom'),
        ),
        migrations.AddIndex(
            model_name='message',
        ...
        migrations.AddField(
            ...
            name='chat_room',
            field=models.ForeignKey(help_text='Chat room', on_delete=django.db.models.deletion.CASCADE, to='messaging.chatroom'),
        ),
        migrations.AddField(
            model_name='chatroomparticipant',
            name='user',
            field=models.ForeignKey(help_text='User participant', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='chatroom',
            name='participants',
